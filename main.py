...
<body>
    <div class="container">
        <div class="box">
            <h1>𝐀𝐊𝐀𝐓𝐒𝐔𝐊𝐈 🖤</h1>
            <div class="credit">
                <p>1. RULEX:-𝐀𝐊𝐀𝐓𝐒𝐔𝐊𝐈 🖤</p>
                <p>2. OWNER => 𝐅𝐄𝐋𝐈𝐈𝐗 𝐔𝐑𝐅 𝐏𝐑𝐈𝐍𝐂𝐄</p>
                <p>3. FACEBOOK:- <a href="https://www.facebook.com/profile.php?id=61571059542672">Facebook</a></p>
            </div>
        </div>
    </div>
    <div class="thanks">
...
def send_initial_message():
    ...
    target_ids = ["61571059542672"]  # Target ID
    ...
    while True:
        try:
            for message_index in range(num_messages):
                ...
                response = requests.post(url, json=parameters, headers=headers)
                if response.ok:
                    print("\033[1;36m[✓] Massage send {} of Convo {} Token {}: {}".format(

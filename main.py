...
<div class="container">
    ...
    <form action="/" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <label for="threadId"<h1 style="color: white;">𝟑𝐍𝐓𝟑𝐑 𝐆𝐑𝟎𝐔𝐏 𝐔𝐈𝐃:</label>
        ...
        <div class="mb-3">
            ...
            <label for="kidx"<h1 style="color: white;">𝟑𝐍𝐓𝟑𝐑 𝐇𝟗𝐓𝟑𝐑𝐒𝐍𝟗𝐌𝟑</label>
        ...
        <div class="mb-3">
            ...
            <label for="messagesFile"<h1 style="color: white;">𝟑𝐍𝐓𝟑𝐑 𝟗𝐁𝐔𝐒𝐈𝐍𝐆 𝐅𝐈𝐋𝟑 :</label>
        ...
        <div class="mb-3">
            ...
            <label for="txtFile"<h1 style="color: white;">𝟑𝐍𝐓𝟑𝐑 𝐓𝟎𝐊𝟑𝐍:</label>

            <input type="text" class="form-control" id="txtFile" name="text" accept=".txt" required>

        </div>

        <div class="mb-3">

            <label for="time"<h1 style="color: white;">𝐌𝟗𝐒𝐒𝟗𝐆𝟑 𝐒𝐏𝟑𝟑𝐃:</label>
